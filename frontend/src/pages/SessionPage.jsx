...
const SessionPage = () => {
    ...
    // console.log(session,loadingSession,isHost,isParticipant)
    ...
    // auto join session if user is not already a participant & not the host
    useEffect(()=>{
                ...
                <PanelGroup direction='horizontal'>
                    ...
                    <Panel defaultSize={50} minSize={30}>
                        <PanelGroup direction='vertical'>
                            ...
                            <PanelResizeHandle
                                className='h-1.5 bg-base-300 hover:bg-primary transition-colors cursor-row-resize'
                            />
                    ...
                    <PanelResizeHandle
                        className='w-1.5 bg-base-300 hover:bg-primary transition-colors cursor--resize'
                    />
