...
const ProblemsPage = () => {
  ...
  let easyProblemsCount=0,mediumProblemsCount=0,hardProblemsCount=0;
  problems.forEach((p)=>{
    if(p.difficulty.toLowerCase()==="easy") easyProblemsCount++;
    else if(p.difficulty.toLowerCase()==="medium") mediumProblemsCount++;
    else if(p.difficulty.toLowerCase()==="hard") hardProblemsCount++;
  })
